...
require (
	...
	github.com/docker/cli v20.10.18+incompatible // replaced below due to github/docker/buildx's requirements
	github.com/docker/distribution v2.8.1+incompatible
	github.com/docker/docker v20.10.18+incompatible // replaced below due to github/docker/buildx's requirements
